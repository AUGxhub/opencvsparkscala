...
object gasiK {
  def main(args: Array[String]) {
    ...
    println("all ready")
    //
    val trainDataPath = "C:\\Users\\augta\\Desktop\\datasets\\二分类数据集\\skin_nonskin"
    ...
    val raw = rawTrain.map {
      x =>
        ...
        if (x.label == "2".toDouble) tempLabel = 1
    ...
    val pramPath = "C:\\Users\\augta\\Desktop\\datasets\\二分类数据集\\skin_nonskin_prams"
